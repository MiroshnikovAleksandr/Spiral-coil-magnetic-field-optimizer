...
class GeneticRectangle:
    ...
    def min_side(self):
        ...
        """
        small_side = min(self.X_side, self.Y_side)
        bounds_const = 2 / small_side
    ...
    def determine_Bz(self, ind: list):
        ...
        """
        R = self.decode(ind)
        return Bz_Field.Bz_square_contour(R=R,
                                          X_side=self.X_side,
                                          Y_side=self.Y_side,
                                          I=self.I,
    ...
    def max_min_bz_ratio(self, ind: list):
        ...
        try:
            ...
            return 1,
        bz_max_min = COV.max_min_bz_rectangle(Bz=bz,
                                              X_side=self.X_side,
                                              Y_side=self.Y_side,
                                              spacing=self.spacing,
                                              cp=self.cp,
